...
wget -q https://github.com/freifunktrier/Supernodes-dynamic/raw/master/iptables-whitelist -O - | grep -E -o '2001:bf7:fc0f:[0-9a-f]{1,4}:[0-9a-f]{1,4}:[0-9a-f]{1,4}:[0-9a-f]{1,4}:[0-9a-f]{1,4}' >> ipv6-whitelist
